		...
		<div class="row main overflow-y-auto w-full clear-both">
			...
			>
				...
				>
					...
					<div class="flex justify-evenly relative h-full -top-2">
						<div
						...
						>
							<div id="teamCard" class="flex-one-one-49perc relative h-full m-dashboardCards">
								<div
									class="teamList bg-fff relative h-full m-teamList rounded-2px p-8 -top-4 overflow-y-auto"
								>
									<div class="flex justify-between">
										...
										<h3 class="uppercase text-4xl font-mono mr-28">{month}</h3>
										<svg
											xmlns="http://www.w3.org/2000/svg"
									...
									{#if months === undefined}
										Loading table ....
									{:else}
										{#each months.months as thismonth, i}
											{#if month === months.months[i].month}
													...
													>
														...
														>
															...
															<div class="mt-2">
																...
																>
																	{months.months[i].cost.toFixed(5)}
																</p>
															</div>
														</div>
														<!-- End of Card 1-->
														...
														>
															...
															<div class="mt-2">
																...
																>
																	{(months.months[i].cost * 0.014).toFixed(5)}
																</p>
															</div>
														</div>
														<!--End of Card 2-->
														...
														<!-- Card 4 -->
														<div
															class="bg-green-600 border-green-600  bg-opacity-95 p-8 rounded-xl grid grid-cols-2 gap-2 cursor-pointer hover:bg-green-400 hover:border-transparent | transition-colors duration-500 {months
																.months[i].isProfit === true
																? 'bg-green-600'
																: 'bg-red-600'}
															{months.months[i].isProfit === true ? 'border-green-600' : 'border-red-600'}
															{months.months[i].isProfit === true ? 'hover:bg-green-400' : 'hover:bg-red-400'}"
														>
															<div class="col-span-2">
																<p class="text-white text-xl">Total Monthly Profit / Loss</p>
															</div>
															{#if months.months[i].isProfit === true}
																<svg
																	xmlns="http://www.w3.org/2000/svg"
																	class="w-12 h-12 object-cover text-white relative -left-4"
																	fill="none"
															...
															<div class="mt-2">
																<p
																	class="text-white text-3xl text-justify font-semibold relative -left-14"
																>
																	{months.months[i].profit_loss_cost}
																</p>
															</div>
														</div>
														<!--End of Card 4-->
